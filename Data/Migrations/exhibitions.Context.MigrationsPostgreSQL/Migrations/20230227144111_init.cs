    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_exhibition_categories", x => new { x.CategoriesId, x.ExhibitionsId });
                    table.ForeignKey(
                        name: "FK_exhibition_categories_categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_exhibition_categories_exhibitions_ExhibitionsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    PhotoBytes = table.Column<byte[]>(type: "bytea", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    ExhibitionsId = table.Column<int>(type: "integer", nullable: false),
                    Subscribed_UsersId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_exhibition_users", x => new { x.ExhibitionsId, x.Subscribed_UsersId });
                    table.ForeignKey(
                        name: "FK_exhibition_users_exhibitions_ExhibitionsId",
                        column: x => x.ExhibitionsId,
                        principalTable: "exhibitions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_exhibition_users_users_Subscribed_UsersId",
                        column: x => x.Subscribed_UsersId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_exhibition_categories_ExhibitionsId",
                table: "exhibition_categories",
                column: "ExhibitionsId");

            migrationBuilder.CreateIndex(
                name: "IX_exhibition_users_Subscribed_UsersId",
                table: "exhibition_users",
                column: "Subscribed_UsersId");
